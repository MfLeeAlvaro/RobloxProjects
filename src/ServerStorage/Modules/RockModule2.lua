...
function RockModule.RayCastEffect(rootpart, numrocks, distance, distance2, Size, Size2)
	...
	for i = 1,numrocks do
		...
		local RayCast = workspace:Raycast(Part.CFrame.p,Part.CFrame.UpVector * - 5, RayParams)
		local RayCast2 = workspace:Raycast(Part2.CFrame.p,Part2.CFrame.UpVector * - 5, RayParams)
